...
export default function MyOrders() {
  ...
  /**
   * Winning a bid raises a transport request straight away, but nobody
   * knows where the load is going until the buyer says. This is one of
   * the two ways to answer that — the other is accepting a storage
   * proposal on the My Storage page. Until one of them happens the trip
   * is not offered to any driver.
   */
              ...
              return (
                <tr key={o.saleOrderId} className={o.status === 'COMPLETED' ? 'row-won' : undefined}>
                  ...
                  <td>
                    ...
                    {/* Where it is going, which is a separate question
                        from how far along the trip is. */}
